...
class DepartmentHeadService
{
    ...
    public function getCompletedTreatmentsForDepartment(int $departmentId, int $page, int $perPage = 15, ?int $groupId = null): Paginator
    {
        ...
        return Cache::remember(
            CacheVersion::taggedKey([CacheGroup::department($departmentId), CacheGroup::TREATMENTS], $cacheKey),
            now()->addMinutes(15),
    ...
    public function getCaseTypesForDepartment(int $departmentId, ?int $courseId = null): Collection
    {
        ...
        return Cache::remember(
            CacheVersion::taggedKey([CacheGroup::department($departmentId), CacheGroup::CASE_TYPES], $cacheKey),
            now()->addHours(2),
    ...
    public function createCaseType(int $hodDepartmentId, array $data): CaseType
    {
        ...
        CacheVersion::bump(CacheGroup::department($hodDepartmentId), CacheGroup::CASE_TYPES);
    ...
    public function getDepartmentStatistics(int $departmentId, ?int $courseId = null): array
    {
        ...
        return Cache::remember(
            CacheVersion::taggedKey([CacheGroup::department($departmentId), CacheGroup::STATISTICS], $cacheKey),
            now()->addMinutes(30),
